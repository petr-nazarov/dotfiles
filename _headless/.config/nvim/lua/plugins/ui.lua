return {
  {
    "catppuccin/nvim",
    name = "catppuccin",
    priority = 1000, -- ensures it loads first for colorscheme and highlights
    config = function()
...

  {
    ...
    opts = {},                            -- use default config unless customized later
  },

  {
    ...
    config = function()
      ...
      require("ibl").setup({
        ...
        -- uncomment if you want rainbow highlight
